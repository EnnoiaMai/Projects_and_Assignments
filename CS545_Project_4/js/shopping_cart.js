...
Can be thought of as a class that analyzes cookies and alters
its String value which represents the product sku and quantity to be sent to the
server for purchase.
...
function shopping_cart(owner) {
    ...
    /*------------------------------ PRIVATE ---------------------------------*/
    /*
        Parses out the value in the cookie named 'jadrn041' so that the shopping
        cart can be updated with what was written to the cookie before.
    */
    this.getCookieValues = function() {
        // Grab all the cookies which will return array ["name"="value"; "name"="value";...]
        ...
        // If cookies exist, split the cookies to list of individual cookies
    ...
    /*
        Creates a new cookie by using name of owner 'jadrn041' and concatenating
    ...
    */
    this.writeCookie = function() {
        ...
        // Removes the extra || separator, and add a semicolon then path attribute
